...
public class PositionList<T> implements IList<T> {
	...
	public Position<T> first() {
		if (header.getNext() == trailer) {
			throw new PositionException("List is empty");
		}
	 ...
	 * @param p an existing Position in the list
	 ...
	 * @param p an exisiting Position in the list
	...
	/**
	 * Convert a Position to a Node and perform the necessary checks to make sure very thing is OK
	 * @param position a Position<T> that was passed by the user
